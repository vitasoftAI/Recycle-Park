...
def run(args):
    ...
    title = "제네시스 자동차 자동 파트번호 찾는 프로그램"
    
    # Set the description
    desc = "'Click to Upload' 누르시고 이미지 선택하시거나 예시 사진 중에 고르세요!"
    
    # Get the samples to be classified
    examples = [[im] for im in glob(f"{args.root}/sample_ims/gen/*.jpg")]
...
if __name__ == "__main__":
    ...
    parser.add_argument("-cp", "--checkpoint_path", type = str, default = "saved_models/genesis30_50_best_model_rexnet_150_new_classes.ckpt", help = "Path to the checkpoint")
